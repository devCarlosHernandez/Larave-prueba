...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject(Lang::get('Restablecer Contraeña'))
            ...
            ->action(Lang::get('Restablecer Contraeña'), $url)
            ->line(Lang::get('Su enlace para restablecer su contraseña caducará en :count minutes.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
